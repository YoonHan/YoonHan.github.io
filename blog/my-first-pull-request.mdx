...
## (20220322 Update) PR Merged
![PR Merged](./images/my-first-pull-request/merged.png)
20220321에 reviewer가 나의 PR을 검토했고, 오타가 맞아서 merge가 되었다!

![Contributors](./images/my-first-pull-request/contributors.png)
이후 Docs 에 내 github ID가 뜨는 것을 확인할 수 있었다. 별것 아닌데 기분이 좋다.